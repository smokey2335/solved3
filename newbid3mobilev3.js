...
// Adding keyboard event listener for mobile devices
...
// Adding mobile orientation change event listener
window.addEventListener('orientationchange', triggerOpenRandomLinksRecursively);
